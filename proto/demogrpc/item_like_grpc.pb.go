...
type ItemLikeServiceClient interface {
	GetItemLikes(ctx context.Context, in *ItemLikesRequest, opts ...grpc.CallOption) (*ItemLikesResponse, error)
}
...
func (c *itemLikeServiceClient) GetItemLikes(ctx context.Context, in *ItemLikesRequest, opts ...grpc.CallOption) (*ItemLikesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ItemLikesResponse)
...
type ItemLikeServiceServer interface {
	GetItemLikes(context.Context, *ItemLikesRequest) (*ItemLikesResponse, error)
}
...
func (UnimplementedItemLikeServiceServer) GetItemLikes(context.Context, *ItemLikesRequest) (*ItemLikesResponse, error) {
...
func _ItemLikeService_GetItemLikes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ItemLikeServiceServer).GetItemLikes(ctx, req.(*ItemLikesRequest))
	}
