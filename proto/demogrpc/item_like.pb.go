...
func (x *ItemLikesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemLikesRequest) ProtoMessage() {}

func (x *ItemLikesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_demogrpc_item_like_proto_msgTypes[0]
...
// Deprecated: Use ItemLikesRequest.ProtoReflect.Descriptor instead.
func (*ItemLikesRequest) Descriptor() ([]byte, []int) {
	return file_demogrpc_item_like_proto_rawDescGZIP(), []int{0}
}

func (x *ItemLikesRequest) GetIds() []int32 {
	if x != nil {
		return x.Ids
	}
	return nil
...
func (x *ItemLikesResponse) Reset() {
	*x = ItemLikesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemLikesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemLikesResponse) ProtoMessage() {}

func (x *ItemLikesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_demogrpc_item_like_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemLikesResponse.ProtoReflect.Descriptor instead.
func (*ItemLikesResponse) Descriptor() ([]byte, []int) {
	return file_demogrpc_item_like_proto_rawDescGZIP(), []int{1}
}

func (x *ItemLikesResponse) GetResult() map[int32]int32 {
	if x != nil {
		return x.Result
	}
	return nil
...
var file_demogrpc_item_like_proto_rawDesc = []byte{
	...
	0x22, 0x24, 0x0a, 0x10, 0x49, 0x74, 0x65, 0x6d, 0x4c, 0x69, 0x6b, 0x65, 0x73, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x05, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0x8b, 0x01, 0x0a, 0x11, 0x49, 0x74, 0x65, 0x6d, 0x4c,
	0x69, 0x6b, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3b, 0x0a, 0x06,
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x64,
	0x65, 0x6d, 0x6f, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x4c, 0x69, 0x6b, 0x65, 0x73, 0x52, 0x65, 0x73,
	...
	0x3a, 0x02, 0x38, 0x01, 0x32, 0x52, 0x0a, 0x0f, 0x49, 0x74, 0x65, 0x6d, 0x4c, 0x69, 0x6b, 0x65,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3f, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x49, 0x74,
	0x65, 0x6d, 0x4c, 0x69, 0x6b, 0x65, 0x73, 0x12, 0x16, 0x2e, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x49,
	0x74, 0x65, 0x6d, 0x4c, 0x69, 0x6b, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x17, 0x2e, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x4c, 0x69, 0x6b, 0x65, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x07, 0x5a, 0x05, 0x64, 0x65, 0x6d, 0x6f,
...
var file_demogrpc_item_like_proto_goTypes = []any{
	(*ItemLikesRequest)(nil),  // 0: demo.ItemLikesRequest
	(*ItemLikesResponse)(nil), // 1: demo.ItemLikesResponse
	nil,                       // 2: demo.ItemLikesResponse.ResultEntry
}
var file_demogrpc_item_like_proto_depIdxs = []int32{
	2, // 0: demo.ItemLikesResponse.result:type_name -> demo.ItemLikesResponse.ResultEntry
	0, // 1: demo.ItemLikeService.GetItemLikes:input_type -> demo.ItemLikesRequest
	1, // 2: demo.ItemLikeService.GetItemLikes:output_type -> demo.ItemLikesResponse
...
func file_demogrpc_item_like_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_demogrpc_item_like_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*ItemLikesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
